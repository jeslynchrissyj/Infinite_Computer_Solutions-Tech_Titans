...
5. **Demo Video**: Link provided in the [demo_video/](file:///demo_video/) folder and directly on [GitHub Pages](https://jeslynchrissyj.github.io/RAG-Chat-App-demo-video-/).
